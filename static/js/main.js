...
const i18n = {
  vi: {
    ...
    'prof.referral.tab.code':       'Mã giới thiệu',
    'prof.referral.tab.link':       'Link giới thiệu',
    'prof.referral.link_hint':      'Người đăng ký qua link này sẽ tự động liên kết với bạn.',
    ...
    'tv.status.coming_soon':  'Sắp ra mắt',
    'tv.coming_soon.label':   'Sản phẩm sắp ra mắt — hãy theo dõi!',
    ...
    /* services page */
    'svc.badge':          'Dịch vụ',
    'svc.title':          'Sàn giao dịch đối tác',
    'svc.subtitle':       'Đăng ký tài khoản tại các sàn uy tín qua link của chúng tôi để nhận ưu đãi đặc biệt và hỗ trợ tốt nhất.',
    'svc.filter.all':     'Tất cả',
    'svc.btn.register':   'Đăng ký ngay',
    'svc.empty':          'Chưa có dịch vụ nào. Vui lòng quay lại sau.',
    'svc.guide.title':    'Hướng dẫn',
    'svc.table.title':    'Bảng hoàn phí',
    /* 404 page */
  ...
  en: {
    ...
    'prof.referral.tab.code':       'Referral Code',
    'prof.referral.tab.link':       'Referral Link',
    'prof.referral.link_hint':      'Anyone who registers via this link will be automatically linked to you.',
    ...
    'tv.status.coming_soon':  'Coming Soon',
    'tv.coming_soon.label':   'Product coming soon — stay tuned!',
    ...
    /* services page */
    'svc.badge':          'Services',
    'svc.title':          'Partner Brokers',
    'svc.subtitle':       'Register an account at reputable brokers through our link to receive exclusive benefits and the best support.',
    'svc.filter.all':     'All',
    'svc.btn.register':   'Register Now',
    'svc.empty':          'No services available yet. Please check back later.',
    'svc.guide.title':    'Guide',
    'svc.table.title':    'Rebate Table',
    /* 404 page */
