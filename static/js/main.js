...
const i18n = {
  vi: {
    ...
    'dep.mm.step1':             'Mở MetaMask, chuyển sang mạng BSC (BNB Smart Chain) — bắt buộc',
    'dep.mm.step2':             'Chọn token USDT — điền địa chỉ ví Admin và số lượng',
    'dep.mm.step3':             'Vào Advanced → Hex Data — dán mã UID của bạn để tự động nhận xu',
    'dep.mm.step4':             'Xác nhận và chờ giao dịch hoàn tất (1–5 phút)',
    ...
    'dep.memo.label':       'Mã nạp tiền (Memo)',
    'dep.memo.hint':        'Điền mã này vào trường Hex Data / Ghi chú khi gửi từ MetaMask để hệ thống tự động nhận xu.',
    'dep.memo.warn.title':  'Lưu ý khi gửi từ MetaMask',
    'dep.memo.warn.desc':   'Bắt buộc điền mã UID vào trường Hex Data khi gửi — nếu không, hệ thống sẽ không tự động nhận biết tài khoản của bạn.',
    'dep.autoscan.title':  'Tự động cộng xu',
    'dep.autoscan.desc':   'Gửi từ MetaMask kèm ghi chú UID (ví dụ: UID-0042) — hệ thống tự động cộng xu sau khoảng 1 tiếng. Gửi từ sàn giao dịch hoặc không có ghi chú UID, hãy nhập TxHash thủ công ở bên phải.',
  ...
  en: {
    ...
    'dep.mm.step1':             'Open MetaMask, switch to BSC (BNB Smart Chain) network — required',
    'dep.mm.step2':             'Select USDT token — enter Admin wallet address and amount',
    'dep.mm.step3':             'Go to Advanced → Hex Data — paste your UID code for auto-credit',
    'dep.mm.step4':             'Confirm and wait for transaction to complete (1–5 min)',
    ...
    'dep.memo.label':       'Deposit Code (Memo)',
    'dep.memo.hint':        'Enter this code in the Hex Data / Note field when sending from MetaMask for automatic credit.',
    'dep.memo.warn.title':  'Important: Sending from MetaMask',
    'dep.memo.warn.desc':   'You must enter your UID code in the Hex Data field — otherwise the system cannot identify your account automatically.',
    'dep.autoscan.title':  'Auto Credit',
    'dep.autoscan.desc':   'Send from MetaMask with UID note (e.g. UID-0042) — coins are credited automatically within ~1 hour. Sending from an exchange or without a UID note? Enter TxHash manually on the right.',
